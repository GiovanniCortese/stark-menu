    ...
    return (
        <div style={{paddingBottom:50}}>
            ...
            <div style={{display:'flex', gap:'20px', marginBottom:'30px', flexWrap:'wrap'}}>
                ...
                <div className="card" style={{flex:1, textAlign:'center', background:'#7f8c8d', color:'white', border:'none', minWidth:'200px'}}>
                    <h3 style={{margin:0}}>€ {Number(stats.incassi.ieri).toFixed(2)}</h3>
                    <p style={{margin:0, opacity:0.8}}>Incasso Ieri</p>
                </div>
                <div className="card" style={{flex:1, textAlign:'center', background: Number(stats.incassi.oggi) >= Number(stats.incassi.ieri) ? '#2ecc71' : '#e74c3c', color:'white', border:'none', minWidth:'200px'}}>
                    <h3 style={{margin:0}}>
            ...
            <div style={{display:'flex', gap:'20px', flexWrap:'wrap', alignItems: 'stretch'}}>
                {/* 2. GRAFICO ORARI DI PUNTA - FIX: Aggiunto wrapper con altezza esplicita */}
                ...
                {/* 3. TOP 5 PIATTI - FIX: Aggiunto wrapper con altezza esplicita */}
