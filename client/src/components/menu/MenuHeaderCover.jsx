...
export default function MenuHeaderCover({
  ...
  return (
    // ✅ Wrapper esterno: overflow visibile così la tendina lingua non viene tagliata
    <div style={{ width: "100%", overflow: "visible" }}>
      {/* ✅ Cover “card” centrata come MenuAccordion */}
      <div
        style={{
          width: "100%",
        ...
        >
          ...
          <div
            ...
            style={{
              position: "relative",
              marginTop: "10px",
              // ✅ unico fix: lingua sopra a tutto
              zIndex: 999999,
            }}
          >
            <button
            ...
            {showLangMenu && (
              <div
                style={{
                  ...
                  minWidth: "120px",
                  // ✅ sopra a tutto (anche fuori dalla card)
                  zIndex: 999999,
                }}
              >
